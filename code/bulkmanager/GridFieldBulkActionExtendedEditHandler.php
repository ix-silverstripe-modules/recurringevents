 ...
 */
class GridFieldBulkActionExtendedEditHandler extends GridFieldBulkActionHandler
{	
	...
	public function bulkEditForm()
	{
		...
		$actions->push(
			FormAction::create('doPublish', 'Save & Publish all')
			->setAttribute('id', 'bulkEditingPublishBtn')
			->addExtraClass('ss-ui-action-constructive')
			->setAttribute('data-icon', 'accept')
			->setUseButtonTag(true)
		);
