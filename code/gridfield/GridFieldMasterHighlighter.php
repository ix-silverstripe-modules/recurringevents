...
class GridFieldMasterHighlighter implements GridField_ColumnProvider {
	...
	public function getColumnContent($gridField, $record, $columnName) {
		...
		Requirements::javascript('recurringevents/javascript/GridFieldMasterHighlighter.js');
		Requirements::css('recurringevents/css/GridFieldMasterHighlighter.css');
			...
			foreach($rule['patterns'] as $nominalvalue => $return) {
				if(
					...
					if(is_callable($message)){
						$message = call_user_func($message, $record);
					}else{
